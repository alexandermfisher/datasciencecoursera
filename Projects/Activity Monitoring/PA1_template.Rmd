...
So from this we can see that the mean number of steps taken per day is `r format(imputed_summary$mean_steps_per_day,scientific=FALSE)`, and the median number of steps is `r format(imputed_summary$median_steps_per_day,scientific=FALSE)`.
